...
import "./App.css";
 ...
 const GroupTeamMembers = ({employees,setTeam,selectedTeam})=>{

  const[groupEmployees, setGroupedEmployees]=useState(groupTeamMembers());
...
return teams;
  ...
  function handleTeamClick(event){
    var TransformedGroupData = groupEmployees.map((groupedData)=>groupedData.team===<event className="currentTarget id"></event>?{...groupedData,collapsed:!groupedData.collapsed}:groupedData );
    setGroupedEmployees(TransformedGroupData);
    setTeam(<event className="currentTarget id"></event>);
